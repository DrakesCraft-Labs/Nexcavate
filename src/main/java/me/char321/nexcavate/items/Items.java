...
import static org.bukkit.Material.CHISELED_POLISHED_BLACKSTONE;
import static org.bukkit.Material.CHISELED_QUARTZ_BLOCK;
...
import static org.bukkit.Material.POLISHED_BLACKSTONE_BRICK_SLAB;
import static org.bukkit.Material.POLISHED_BLACKSTONE_BRICK_STAIRS;
import static org.bukkit.Material.QUARTZ_PILLAR;
...
public class Items {
    ...
    public static final RecipeType DUMMY_TYPE = new RecipeType(Nexcavate.key("invalid"), new CustomItemStack(
            Material.BARRIER,
            "&l&4¡Ahora mismo no puedes ver la receta!",
            "&7Consulta la receta en la mesa de investigación"));
    ...
    public static void init() {
        StructurePiece lantern = u(new CustomItemStack(LANTERN, "Farol o farol de almas"), mat(LANTERN), mat(SOUL_LANTERN));
        ...
        StructurePiece extension = u(new CustomItemStack(POLISHED_BLACKSTONE_BRICKS, "Pieza de ensambladora", "&7Cualquier pieza de ensambladora o ladrillo de piedra negra pulida"), mat(POLISHED_BLACKSTONE_BRICKS));
